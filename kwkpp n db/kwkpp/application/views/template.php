...
<tr>
	...
	<td align="right" valign="top"><?php if(is_logged()): ?><a href="<?php echo base_url()?>index.php/auth/logout" title="Log Keluar"><img border="0" src="<?php echo base_url()?>application/images/labyrinth.PNG" valign="bottom"></a><?php endif; ?></td>
</tr>
<tr>
