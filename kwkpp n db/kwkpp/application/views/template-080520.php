...
<body  <?php echo $setfocus; ?> class="" background="<?php echo base_url()?>application/images/logo/" > <!-- logotnb_blur.png backgroundExpertFootballBlue.gif -->
<div id="content">
<div class="header">
<table width="100%" border="0">
<tr>
<td rowspan="2" width="281px" height="65px" valign="top"><a href="<?php echo base_url()?>index.php/ms" title="TNB"><img border="0" src="<?php echo base_url()?>application/images/logo/logotnb_small.png" valign="bottom"></a></td>
<td align="left" valign="bottom"><i><font size="5" face="Arial"><strong>&nbsp;&nbsp;&nbsp;SISTEM MAKLUMAT KWKPPTNB</font></strong><!-- <font size="1" face="Arial">[<?php echo base_url()?>]</font> --></i></td>
<?php if(is_logged()):?>
<td rowspan="2" align="right" valign="top"><a href="javascript:popwin('<?php echo base_url().'application/help/Outtask Proposal KWKPP.pdf'?>',800,600)" title="Bantuan">Bantuan</a></td>
<?php endif;?>
</tr>
	<tr>
		<td align="left" valign="top"><i><font size="1" face="Arial"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;KUMPULAN WANG KHAIRAT PEKERJA & PESARA TNB</strong></font></i></td>
	</tr>
</table>
</div>
<br>
