...
.left {	float: left; padding: 5px 5px 0 5px; width: 150px; border-right: 1px solid #e6e6e6; }
.right { float: left; width: 670px; margin: 0 0 20px 0;  padding: 5px 5px 0 15px;  color: #000; background-color: #FFFFFF; }
