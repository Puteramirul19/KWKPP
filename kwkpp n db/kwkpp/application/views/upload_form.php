...
<?php echo form_open_multipart('importcontri/do_read');?>
<p class="mainheader">Import Data dari Fail Sumbangan Kematian</p>
<?php
echo form_open_multipart('importcontri/do_read');
echo "<table>";
...
<img border="0" src="<?php echo base_url()?>application/images/data-format/dataFormat-Import_Sumbangan_Kematian.png" valign="bottom">
</UL>
</fieldset>
