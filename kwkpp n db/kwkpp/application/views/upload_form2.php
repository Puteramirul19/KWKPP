...
<?php echo form_open_multipart('importbeneficiariesfee/do_read');?>
<p class="mainheader">Import Data dari Fail Bayaran Tukar Penama</p>
<?php
echo form_open_multipart('importbeneficiariesfee/do_read');
echo "<table>";
...
<img border="0" src="<?php echo base_url()?>application/images/data-format/dataFormat-Import_Bayaran_Tukar_Penama.png" valign="bottom">
</UL>
</fieldset>
