...
<blockquote>
	<table width="100%" border="0">
		<tr>
			<td height="10" align="right" width="94%">
			<h2>PENYATA AKAUN</h2>
			</td>
			<td height="10" align="right" width="5%">
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td height="10" colspan="2"><font size="2">Tingkat 10, TNB Ibu Pejabat No 129, Jalan Bangsar</font></td>
		</tr>
		<tr>
			<td colspan="2"><span class="style29 style38"><font size="2">59200 Kuala Lumpur (Tel:03-229 66134 / 03-2296 6947) 
			</font></span></td>
		</tr>
		<tr>
			<td colspan="2"><hr>
		...
		<tr>
			...
			<table width="95%" border="0">
				<tr>
					<td width="16" bgcolor="#000000" align=left>
					<font color="#FFFFFF"><b>Bil</b></td>
					<td width="39" bgcolor="#000000" align=left>
					<font color="#FFFFFF"><b>Tarikh</b></td>
					<td width="134" bgcolor="#000000" align=left>
					<font color="#FFFFFF"><b>Perkara</b></td>
					<td width="28" bgcolor="#000000" align=left>
					<font color="#FFFFFF"><b>Ruj.</b></td>
					<td width="78" bgcolor="#000000" align=left>
					<font color="#FFFFFF"><b>Debit(RM)</b></td>
					<td width="88" bgcolor="#000000" align=left>
					<font color="#FFFFFF"><b>Kredit(RM)</b></td>
					<td width="74" bgcolor="#000000" align=left>
        ...
        <?php echo $insert_row ?> 
				...
				<tr>
					...
					<div align="center" class="style39"></div></td>
					<td>
					<div align="right" class="style39"><b><font size="4"><?php echo $baki ?></font></b>&nbsp;&nbsp;&nbsp;</div>
					</td>
				</tr>
				<tr>
					<td>&nbsp;</td>
		...
		<tr>
			<td colspan="2"><font size="2">(SEMUA URUSNIAGA DALAM RINGGIT MALAYSIA)</font></font></td>
		</tr>
		<tr>
			<td colspan="2">
