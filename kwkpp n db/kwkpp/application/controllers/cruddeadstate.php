...
class Cruddeadstate extends BaseController {

  var $data_type = null;   
  var $data = null;


	function Cruddeadstate()
	{
  ...
  function index()
  {
    ...
    redirect("cruddeadstate/filteredgrid");
  ...
  function filteredgrid()
  {
    ...
    $filter->db->select("*");
    $filter->db->from("kwkpp_negeri_mati");
    ...
    $uri = "cruddeadstate/dataedit/show/<#negeriID#>";
	...
	$grid->column_detail("Kod Negeri", "negeriCode", $uri);
	$grid->column_detail("Negeri", "negeriDesc", $uri);
    
    $grid->add("cruddeadstate/dataedit/create");
    $grid->build();
    /**/
  ...
  {  
    ...
    $edit = new DataEdit("Negeri", "kwkpp_negeri_mati");
    $edit->back_uri = "cruddeadstate/filteredgrid";
