...
//	$edit->penamaID->rule = "required";	
	...
	$edit->namaCek = new inputField("Nama Penerima", "namaCek");
	...
	$edit->PIC->insertValue = get_user_data("user_name");
	$edit->PIC->updateValue = get_user_data("user_name");
	$edit->PIC->when = array("show");
