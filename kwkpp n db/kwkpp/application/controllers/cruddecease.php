...
class Cruddecease extends BaseController {
  ...
  function filteredgrid()
  {
    ...
    $filter->db->select("*, date_format(k.tarikhMati, '%Y-%m-%d') as 'dd', date_format(k.tarikhDaftarMati, '%Y-%m-%d') as 'rd', @rownum:=@rownum+1 as 'c'");
	...
	$filter->noMati = new inputField("No Kematian", "kematianID");
	$filter->noMati->clause="where";
	$filter->noMati->operator="=";
/*	
...
*/
	...
	$grid->column("Tarikh Mati","<#dd#>","nowrap");
