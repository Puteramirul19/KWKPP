...
class Exportbeneficiariesfee extends BaseController {

  var $data_type = null;   
  var $data = null;


	function Exportbeneficiariesfee()
	{
  ...
  ##### index #####
	...
	{	
		...
		$this->_render('exportbeneficiariesfee_view', $data);
...
$date = date("d-m-Y");
$filename = "BAYARAN_TUKAR_PENAMA_SETAKAT_" . $date . ".xls ";
...
echo "BAYARAN TUKAR PENAMA KWKPP BAGI BULAN ".$_POST[bulan]." TAHUN ".$_POST[tahun]." SETAKAT ".$date."\n"; 
echo "\n";
