...
class Crudmembers extends BaseController {
  ...
  function filteredgrid()
  {
    ...
    $filter->db->select("*, concat('AB',noAhliAB) as 'noAhliAB', concat('SH',noAhliSH) as 'noAhliSH', tarikhMasuk");
// date_format(kwkpp_ahli_khairat.tarikhMasuk, '%d/%m/%Y') as 'rd'
	...
	$popup_uri_html = "membercert_html/dataedit/show/<#ahliKhairatID#>";
	...
	$grid->column_detail_popwin("No IC <br><font class=\"alert\">(klik untuk cetak sijil)</font>", "noIC", $popup_uri_html, '900', '600', '1');
