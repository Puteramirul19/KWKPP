...
/***
	...
	//$ahliID = '00001'; //intval($this->uri->segment(4));
$ahliID = intval($this->uri->segment(6));
	$do->load($ahliID);
    $kod = $do->get_all();
*/
	...
	//$edit->noAhliAB = new inputField("No Ahli AB", $data["AB"]);
	$edit->noAhliAB = new freeField("No Ahli Biasa","noAhliAB",$data["AB"]);  
    $edit->noAhliSH = new freeField("No Ahli S. Hidup","noAhliSH", $data["SH"]);
/** commented cause wanna have separated between AB/SH membership no. as above
if($this->uri->segment(5)==="show" || $this->uri->segment(3)==="show")
		{
