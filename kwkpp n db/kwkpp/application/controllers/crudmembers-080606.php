...
class Crudmembers extends BaseController {
  ...
  function filteredgrid()
  {
	...
	$grid->column_detail("No Ahli <br><font class=\"alert\">(klik untuk daftar mati)</font>", "jenisAhliCodeahliKhairatID", $uri_mati);  
	
	$grid->column("No IC","<#noIC#>");
    //$grid->column_detail_popwin("Nama","<substr><#nama#>|0|25</substr>", $popup_uri,"1000","500","1");
	$grid->column_detail("Nama <br><font class=\"alert\">(klik untuk cetak sijil)</font>","nama", $popup_uri);
...
if($this->uri->segment(5)==="show" || $this->uri->segment(3)==="show" || $this->uri->segment(5)==="modify")
	{
	...
	elseif($this->uri->segment(3)==="show")
...
$edit->alamat = new textareaField("Alamat", "alamat");
$edit->alamat->rows = "5";
