        ...
        foreach ($this->_fields as $fieldname=>$field){
          ...
          if ($field->value!=""){
            ...
            switch ($field->clause){
                ...
                break;
				/**get the condition for where between <wherebetween1st> and <wherebetween2nd>*/
                case "wherebetween1st":
                    $this->db->wherebetween1st_datetime($name." ".$field->operator, $value);
                break;   
				
                case "wherebetween2nd":
					$this->db->wherebetween2nd_datetime($name." ".$field->operator, $value);
                break;  
				/**get the condition for where between <wherebetween1st> and <wherebetween2nd>*/
				//..
