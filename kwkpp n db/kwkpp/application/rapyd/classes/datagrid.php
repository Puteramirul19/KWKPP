...
class DataGrid extends DataSet{
  ...
  * @param    string  $headerParams  "td" free attributes (ex:  width="100")'style="width:60px;padding-right:5px;text-align:left;"'
  * @return   void
  */
  function column_detail($label,$pattern,$uri,$headerParams=null){
...
/**
Same as column_detail function but link with popwin windows
**/
  function column_detail_popwin($label,$pattern,$uri,$width,$height,$menubar=null,$headerParams=null){
    ...
    $popup_uri = "javascript:popwin('".base_url()."index.php/".$uri."',".$width.",".$height.",".$menubar.")";
    $column->url = $popup_uri; 
    $column->orderby_field = $pattern;
    $this->columns[] = $column;
  }
