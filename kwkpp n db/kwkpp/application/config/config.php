...
|
*/
//$config['base_url']	= "http://teratai.hq.tnb.com.my/kwkpp/";
$config['base_url']	= "http://localhost/kwkpp/";
//$config['base_url']	= "http://192.168.0.13/codeigniter_rapyd/";
