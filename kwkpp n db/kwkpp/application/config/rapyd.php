...
/*
|--------------------------------------------------------------------------
| Routing Inner control
|--------------------------------------------------------------------------
| Internal Link are base on URI or RURI, in URI mode direct route to a controller function including Rapyd component
| should crash, in this case switch to RURI
|*/
$rpd['rapyd_ruri_ON']= True;
