...
mySQL dump for rapyd samples

Notes:
- see /application/config/database.php to manage your connection settings
...
*/
    ...
    INSERT INTO `users` (`user_id`,`role_id`,`act_key`,`act_ip`,`user_name`,`password`,
        ...
        VALUES (1,'4','','','test','a94a8fe5ccb19ba61c4c0873d391e987982fbbd3',
                'email@email.com','name','lastname','y', '0000-00-00 00:00:00');
    INSERT INTO `users` ( `user_id` , `role_id` , `act_key` , `act_ip` , `user_name` , `password` ,  `email` , `name` , `lastname` , `active` , `lastlogin` )
        VALUES ( 2, '3', '', '', 'felix', 'a94a8fe5ccb19ba61c4c0873d391e987982fbbd3', 'felix@rapyd.com', 'name', 'lastname', 'y', '0000-00-00 00:00:00' ) ;
